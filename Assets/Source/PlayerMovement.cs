...
public class PlayerMovement : MonoBehaviour
{
    ...
    Vector3 ClampPositionWithinBounds(Vector3 position)
    {
        ...
        {
            Debug.LogWarning("Отсутствует коллайдер, ограничивающий движение.");
            return position;
        }
    ...
    public void ContGame()
    {
        ...
        }, () =>
        {
            ...
            isGameActive = true;
            Cursor.visible = true;          // Включаем видимость курсора на всякий случай
            Cursor.lockState = CursorLockMode.None; // Разблокируем курсор, если он заблокирован

            FollowCursor(); // Запускаем слежение за курсором
